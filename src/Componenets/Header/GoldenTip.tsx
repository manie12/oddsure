...
import { Grid, Typography, Button, Fade, Backdrop, Modal } from '@material-ui/core';
import ball from '../../Image/ball.gif';
import { GoldenData, BasicVarsId } from '../../GraphQl/Types';
            ...
            >
                <Fade in={open}>
                    <div className={classes.paper}>
                        <h2 id="transition-modal-title">Golden Tips <span style={{ color: "red" }}>Kshs. 500</span></h2>
